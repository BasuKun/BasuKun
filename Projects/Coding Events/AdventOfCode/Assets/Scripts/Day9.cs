...
namespace intcode
{
    public class Day9 : MonoBehaviour
    {
        ...
        private void Awake()
        {
            System.Array.Resize(ref program, program.Length + 520000);
        }
